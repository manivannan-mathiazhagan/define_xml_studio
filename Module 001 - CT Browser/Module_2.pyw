...
# ====================================================================================================
# Script Name    : Metadata_Studio_Module2_SharePoint.pyw
#
# Author         : Manivannan Mathialagan
# Created Date   : 13-May-2026
#
# Purpose        :
#                  Module 2 prototype for Clinical Metadata Studio.
#
#                  This tool loads a study specification workbook from SharePoint using the existing
#                  get_spreadsheet.py utility, imports all sheets, asks for a SAS/XPT dataset folder,
#                  and displays the specification/dataset metadata in a PyQt5 GUI.
#
# Key Features   :
#                  • SharePoint spec import using get_spreadsheet.py
#                  • Site Name and SharePoint File Path entered by user
#                  • Temporary Excel download to C:\TEMP
#                  • Imports all Excel sheets
#                  • Detects domain/dataset sheets
#                  • Uses column E / KEEP-style logic where value 1 means variable is used
#                  • SAS/XPT folder selection
#                  • Dataset file inventory
#                  • Spec metadata browser
#                  • Dataset vs Spec comparison placeholder
#                  • CT validation preview placeholder
...
#
# Run            :
#                  python Metadata_Studio_Module2_SharePoint.pyw
#
# ====================================================================================================
